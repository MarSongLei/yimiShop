<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:59:"G:\bai\tp5\public/../application/admin\view\image\list.html";i:1506525142;s:62:"G:\bai\tp5\public/../application/admin\view\common\header.html";i:1501662058;s:60:"G:\bai\tp5\public/../application/admin\view\common\left.html";i:1502084228;}*/ ?>
<!DOCTYPE html>
<html><head>
  <meta charset="utf-8">
  <title></title>
  ...
  <!-- /Sidebar Menu -->
    ...
    <div class="page-content">
      ...
      <div class="page-body">
        ...
        <button type="button" tooltip="添加用户" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('Image/add',['goods_id'=>$goods_id]); ?>'"> <i class="fa fa-plus"></i> Add
        </button>
        <div class="row">
                ...
                <div class="flip-scroll">
                  <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td style="line-height:97px;text-align: center;"><?php echo $v['image_id']; ?></td>
                        ...
                        <td style="line-height:97px;text-align: center;">
                          <?php if($v['is_face'] == 1): ?>
                          <?php echo !empty($v['is_face']) && $v['is_face']==1?'√':'X'; else: ?>
                          <a href="<?php echo url('Image/doFace',['image_id'=>$v['image_id'],'goods_id'=>$v['goods_id']]); ?>" title="点我变封面"><?php echo !empty($v['is_face']) && $v['is_face']==1?'√':'X'; ?></a>
                          <?php endif; ?>
                        </td>
                        <td style="line-height:97px;text-align: center;">
                          <a href="<?php echo url('Goods/index'); ?>"  class="btn btn-danger btn-sm shiny" style="margin-right: 10px">
                            <i class="fa fa-trash-o"></i> 返回
                          <a href="#" onClick="warning('确实要删除吗', '<?php echo url('Image/delete',['image_id'=>$v['image_id']]); ?>')" class="btn btn-danger btn-sm shiny">
