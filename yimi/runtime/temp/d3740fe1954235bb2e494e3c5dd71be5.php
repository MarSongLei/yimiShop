<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:60:"G:\bai\tp5\public/../application/admin\view\cate\update.html";i:1501654612;s:62:"G:\bai\tp5\public/../application/admin\view\common\header.html";i:1501662058;s:60:"G:\bai\tp5\public/../application/admin\view\common\left.html";i:1506684490;}*/ ?>
<!DOCTYPE html>
<html><head>
  <meta charset="utf-8">
  <title></title>
            ...
            <div class="widget">
              ...
              <div class="widget-body">
                <div id="horizontal-form">
                  <form class="form-horizontal" role="form" action="<?php echo url('Cate/doUpdate'); ?>" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6">
                        <input class="form-control" id="username" placeholder="" name="cate_name" value="<?php echo $data['cate_name']; ?>" required="" type="text">
                      </div>
