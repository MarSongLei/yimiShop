<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:60:"G:\bai\tp5\public/../application/admin\view\member\list.html";i:1502085878;s:62:"G:\bai\tp5\public/../application/admin\view\common\header.html";i:1501662058;s:60:"G:\bai\tp5\public/../application/admin\view\common\left.html";i:1506684490;}*/ ?>
<!DOCTYPE html>
<html><head>
  <meta charset="utf-8">
  <title></title>
  ...
  <!-- /Sidebar Menu -->
    ...
    <div class="page-content">
      ...
      <div class="page-body">
        ...
        <button type="button" tooltip="添加用户" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('Member/add'); ?>'"> <i class="fa fa-plus"></i> Add
        </button>
        <div class="row">
                  ...
                  <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td align="center">
                          <a href="<?php echo url('Member/edit',['member_id'=>$v['member_id']]); ?>" class="btn btn-primary btn-sm shiny">
                            <i class="fa fa-edit"></i> 编辑
                          </a>
                          <a href="#" onClick="warning('确实要删除吗', '<?php echo url('Member/delete',['member_id'=>$v['member_id']]); ?>')" class="btn btn-danger btn-sm shiny">
