<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:61:"G:\bai\tp5\public/../application/admin\view\cate\addcate.html";i:1501653378;s:62:"G:\bai\tp5\public/../application/admin\view\common\header.html";i:1501662058;s:60:"G:\bai\tp5\public/../application/admin\view\common\left.html";i:1502084228;}*/ ?>
<!DOCTYPE html>
<html><head>
  <meta charset="utf-8">
  <title></title>
    ...
    <div class="page-content">
      ...
      <div class="page-breadcrumbs">
        <ul class="breadcrumb">
          ...
          <li>
            <a href="<?php echo url('Manager/index'); ?>">子分类管理</a>
          </li>
            ...
            <div class="widget">
              ...
              <div class="widget-body">
                <div id="horizontal-form">
                  <form class="form-horizontal" role="form" action="<?php echo url('Cate/doAddCate'); ?>" method="post">
                    <!--父类的id 就是 子类的pid-->
                    <input type="hidden" name="cate_id" value="<?php echo $cateData['cate_id']; ?>">
                    <!--父类的path  父类的path 拼上自己的id-->
                    <input type="hidden" name="cate_path" value="<?php echo $cateData['cate_path']; ?>">
                    <!--父类的level  -->
                    <input type="hidden" name="cate_level" value="<?php echo $cateData['cate_level']; ?>">
                    <div class="form-group">
                      <label for="username" class="col-sm-2 control-label no-padding-right">所属分类</label>
                      <div class="col-sm-6">
                        <input class="form-control" value="<?php echo $cateData['cate_name']; ?>" readonly required="" type="text">
                      </div>
                    </div>

                    <div class="form-group">
                      <label for="username" class="col-sm-2 control-label no-padding-right">子分类名</label>
                      <div class="col-sm-6">
